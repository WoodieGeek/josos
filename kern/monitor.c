...
int mon_magic_number(int argc, char **argv, struct Trapframe *tf);
...
static struct Command commands[] = {
        ...
        {"magic_number", "Print magic number", mon_magic_number},
};
...
int
mon_magic_number(int argc, char **argv, struct Trapframe *tf) {
    cprintf("Magic number is: %d\n", 42);
    return 0;
}
